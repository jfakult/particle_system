...
func _init(_steps_per_frame: int = 1, _width: int = 1280, _height: int = 720, _num_agents: int = 1000,
           _spawn_mode: int = SpawnMode.RANDOM, _trail_weight: float = 100.0, _decay_rate: float = 1.0,
